...
START_RELOC_NUMBERS(elf_mrisc32_reloc_type)
  ...
  RELOC_NUMBER (R_MRISC32_PCREL_14, 2)
  ...
  RELOC_NUMBER (R_MRISC32_I21, 9)
  RELOC_NUMBER (R_MRISC32_IHI21, 10)
  RELOC_NUMBER (R_MRISC32_IHIO21, 11)
  RELOC_NUMBER (R_MRISC32_ILO11, 12)
  RELOC_NUMBER (R_MRISC32_ILO9X4, 13)
  RELOC_NUMBER (R_MRISC32_I21X4, 14)

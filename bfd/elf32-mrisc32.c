...
static reloc_howto_type elf_mrisc32_howto_table_rel[] =
{
  ...
  /* 14 high bits immediate relocation.  */
  HOWTO (R_MRISC32_IHI14,	/* type */
         18,			/* rightshift */
         4,			/* size (bytes) */
         14,			/* bitsize */
         false,			/* pc_relative */
  ...
  /* 20 bits immediate relocation.  */
  HOWTO (R_MRISC32_I20,		/* type */
         0,			/* rightshift */
         4,			/* size (bytes) */
         20,			/* bitsize */
         false,			/* pc_relative */
  ...
  /* 19 high bits immediate relocation.  */
  HOWTO (R_MRISC32_IHI19,	/* type */
         12,			/* rightshift */
         4,			/* size (bytes) */
         19,			/* bitsize */
         false,			/* pc_relative */
         ...
         complain_overflow_dont, /* complain_on_overflow */
         bfd_elf_generic_reloc, /* special_function */
         "R_MRISC32_IHI19",	/* name */
         false,			/* partial_inplace */
         0,			/* src_mask */
         0x000ffffe,		/* dst_mask */
         false),		/* pcrel_offset */

  /* 13 low bits immediate relocation.  */
  HOWTO (R_MRISC32_ILO13,	/* type */
         0,			/* rightshift */
         4,			/* size (bytes) */
         13,			/* bitsize */
         false,			/* pc_relative */
...
static const struct mrisc32_reloc_map mrisc32_reloc_map [] =
{
  ...
  { BFD_RELOC_MRISC32_RELAX,        R_MRISC32_RELAX },
  ...
  { BFD_RELOC_MRISC32_I20,          R_MRISC32_I20 },
  { BFD_RELOC_MRISC32_IHI20,        R_MRISC32_IHI20 },
  { BFD_RELOC_MRISC32_IHI19,        R_MRISC32_IHI19 },
  { BFD_RELOC_MRISC32_ILO13,        R_MRISC32_ILO13 },
  { BFD_RELOC_MRISC32_ILO11X4,      R_MRISC32_ILO11X4 },
...
static bool
mrisc32_elf_relax_section (bfd *abfd,
			   asection *sec,
...
#define bfd_elf32_bfd_relax_section	mrisc32_elf_relax_section

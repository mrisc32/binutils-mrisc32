...
const mrisc32_opc_info_t mrisc32_opc_type_b_info[4][64] = {
  ...
  /* 0x7e  */
  {
    { "wait",     MR32_VC_NA,  MR32_VC_NA,  MR32_FT_NONE,  0x7e, 0, MR32_FMT_B, MR32_MODE_NONE },
    { "sync",     MR32_VC_NA,  MR32_VC_NA,  MR32_FT_NONE,  0x7e, 1, MR32_FMT_B, MR32_MODE_NONE },
    { "cctrl",    MR32_VC_NA,  MR32_VC_NA,  MR32_FT_NONE,  0x7e, 2, MR32_FMT_B, MR32_MODE_2REG },
    ...
    { "crc32c",   MR32_VC_VVS, MR32_VC_VVV, MR32_FT_WIDTH, 0x7e, 8, MR32_FMT_B, MR32_MODE_2REG },
    { "crc32",    MR32_VC_VVS, MR32_VC_VVV, MR32_FT_WIDTH, 0x7e, 9, MR32_FMT_B, MR32_MODE_2REG },

...
const mrisc32_opc_info_t mrisc32_opc_type_a_info[124] =
{
  ...
  { "fsunord",  MR32_VC_VVS, MR32_VC_VVV, TRUE,  0x66, 0, MR32_FMT_A, MR32_MODE_3REG },
  { "fsord",    MR32_VC_VVS, MR32_VC_VVV, TRUE,  0x67, 0, MR32_FMT_A, MR32_MODE_3REG },
...
const mrisc32_opc_info_t mrisc32_opc_type_b_info[4][64] = {
  ...
  /* 0x7d  */
  {
    { "funpl",    MR32_VC_VVS, MR32_VC_VVV, TRUE,  0x7d, 0, MR32_FMT_B, MR32_MODE_2REG },
    { "funph",    MR32_VC_VVS, MR32_VC_VVV, TRUE,  0x7d, 1, MR32_FMT_B, MR32_MODE_2REG },
    ...
    { "fsqrt",    MR32_VC_VVS, MR32_VC_VVV, TRUE,  0x7d, 8, MR32_FMT_B, MR32_MODE_2REG },
